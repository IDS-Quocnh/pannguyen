...
function playVid(vidId, noBlackout) {
	...
	if (vidId==null) { 
        ...
        vidstring+=' wmode="transparent" pluginspage="../www.macromedia.com/go/getflashplayer" ';

        if (vidInfo[2].indexOf('youtube.com')>=0) {
        	vidInfo=vidId.match(/v=.+$/);
           	vidInfo=String(vidInfo).replace(/v=/g,'');
           	vidstring+=' src="../www.youtube.com/v/'+vidInfo+'@fs=1&autoplay=1" ';
          	...
          	vidInfo=String(vidInfo).replace(/watch./,'');
           	...
           	vidstring+=' src="../www.metacafe.com/fplayer/'+vidInfo+'.swf" ';
			...
			vidstring+=' src="../www.dailymotion.com/swf/video/'+vidInfo+'?&autoPlay=1&start=" flashVars="autoStart=1" ';
		 	...
		 	var vidtemp = new Array();
		  	...
		  	vidstring+=' src="../d.yimg.com/static.video.yahoo.com/yep/YV_YEP.swf" ';
           	...
           	vidstring+=' src="../vimeo.com/moogaloop.swf@clip_id='+vidInfo+'&server=vimeo.com&show_title=1&show_byline=1&show_portrait=1&color=00ADEF&fullscreen=1&autoplay=1&loop=0" ';
           	vidstring+=' height="350" width="425" allowfullscreen="true"></embed></center>';
        } else {
